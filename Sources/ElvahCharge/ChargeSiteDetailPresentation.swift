...
public extension View {
	/// Presents a modal view showing a charge site detail view where users can start a new in-app charge
	/// session. Its presentation is controlled by the provided binding to a ``ChargeSite`` object.
	///
	...
	/// the wrapped view.
	/// - Returns: A view that presents a campaign detail view using the given ``ChargeSite`` object.
	@ViewBuilder func chargeSiteDetailPresentation(
		for chargeSite: Binding<ChargeSite?>,
	) -> some View {
