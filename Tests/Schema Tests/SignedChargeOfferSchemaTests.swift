...
/// Tests for SignedChargeOffer schema parsing functionality.
@Suite("SignedChargeOffer Schema Parsing Tests", .tags(.parsing))
struct SignedChargeOfferSchemaTests {
  ...
  func signedChargeOfferMissingTokenError() throws {
    ...
    let schema = try SchemaTestHelpers.decodeSchema(invalidJSON, as: ChargeOfferSchema.self)
  ...
  func signedChargeOfferParseFromSiteOffer() throws {
    ...
    let schema = try SchemaTestHelpers.decodeSchema(siteOfferJSON, as: SiteOfferSchema.self)
